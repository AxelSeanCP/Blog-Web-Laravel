<nav class="bg-gray-800" x-data="{ isOpen: false, isOn: false }">
        ...
        <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="size-8 rounded-full"
                                    src="{{ asset('storage/images/' . auth()->user()->photo) ?? asset('storage/images/noimage.png') }}"
                                    alt="">
                            </button>
                        </div>
                        ...
                        <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                            ...
                            <a href="/home" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                tabindex="-1" id="user-menu-item-0">Your Profile</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                tabindex="-1" id="user-menu-item-1">Settings</a>
                            <form action="/logout" method="POST">
                                @csrf
                                <button class="block px-4 py-2 text-sm text-gray-700" role="menu-item">Sign out</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button @click="isOn = !isOn" type="button"
                    ...
                    <svg :class="{ 'hidden': isOn, 'block': !isOn }" class="block size-6" fill="none"
                    ...
                    <svg :class="{ 'block': isOn, 'hidden': !isOn }" class="hidden size-6" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"
                        data-slot="icon">
    ...
    <div x-show="isOn" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <x-nav-link href="/posts" :active="request()->is('posts')" :isMobile="true">Blog</x-nav-link>
